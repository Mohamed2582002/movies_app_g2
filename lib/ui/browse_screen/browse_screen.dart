...
class _BrowseScreenState extends State<BrowseScreen> {
  ...
  Future<void> fetchCategories() async {
    ...
    List<String> apiCategories = ["Action", "Adventure", "Animation", "Biography"];
  ...
  Future<void> fetchMovies() async {
    ...
    List<Map<String, String>> apiMovies = [
      ...
      {"title": "Joker", "image": "https://via.placeholder.com/150", "rating": "7.7"},
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Colors.yellow, width: 1), // ✅ *إضافة بوردر للـ Categories*
        ),
        child: Text(category, style: TextStyle(color: isSelected ? Colors.black : Colors.yellow)),
      ),
    );
  }
